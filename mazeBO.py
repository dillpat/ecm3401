...
class PlayLog:
    """" Records the event from each iteration """
...
def addCoins(m, quadrant, coin_position_list = {}, number=MAX_COIN):
    """
    Function to add coins to the maze

    :param m: The current maze
    :param quadrant: The quadrants to which the coins are being added to
    :param coin_positon_list: Dictionary indicating the location of the coins
    param number: The max number of coins
    """
    coin_count = 0
...
def findNearestCoin(m, start_position, coin_position_list):
    ...
    :param m: The current maze
    :param start_position: The start cell position
    :param coin_positon_list: Dictionary indicating the location of the coins
    """
...
def collectNearestCoins(m, coin_position_list, start_cell = None, coin_target = COIN_TARGET):
    """
    Travelling to the nearest coin

    :param m: The current maze
    :param coin_positon_list: Dictionary indicating the location of the coins
    :param start_cell: The start cell
    :param coin_target: The number of coins the player aims to collect
    """
...
def addEnemy(m, quadrant, enemy_list = {}, number = MAX_ENEMY):
    """
    Function to add enemies to the maze

    :param m: The current maze
    :param quadrant: The quadrants to which the enemies are being added to
    :param enemy_list: Dictionary indicating the location of the coins
    param number: The max number of enemies
    """
    enemy_count = 0
...
def findNearestEnemy(m, start_position, enemy_list):
    ...
    :param m: The current maze
    :param start_position: The start cell position
    :param enemy_list: Dictionary indicating the location of the enemies
    """
...
def combatNearestEnemy(m, enemy_list, start_cell = None, player_health = 80, enemy_target = ENEMY_TARGET):
    """
    Travelling to the nearest enemy

    :param m: The current maze
    :param enemy_list: Dictionary indicating the location of the enemies
    :param start_cell: The start cell
    :param player_health: The player's health 
    :param enemy_target: The number of enemies the player aims to defeat
    """
...
def combat(enemy, player_health):
    """
    Fighting the enemy to set its state as defeated

    :param enemy: Yhe enemy being fought
    :param player_health: The player's health
    """
...
def restoreHealth(m, current_health, enemy):
    """
    Restores the full health of the player

    :param m: The current maze
    :param current_health: The player's current health
    :param enemy: The enemy who has defeated the player
    """
    home = (m.rows,m.cols)
...
def divideQuadrants(m):
    """ Divides the maze into 4 quadrants """
    cNW = []
    cNE = []
    cSW = []
    cSE = []
...
def createQuadrantDictionary(m,cNW, cNE, cSW, cSE):
    """ Creates the quadrant dictionary """
...
def setProbability(m, distribution_dict, pNW = 0.25, pNE = 0.25, pSW = 0.25, pSE = 0.25):
    """ Sets the probability of each quadrant """
...
def findOnlyCoin(m, start_position, coin_position_list):
    """
    Finds only the coins whilst placing wieght on paths with enemies

    :param m: The current maze
    :param start_position: The start positon on the maze
    :param coin_positon_list: Dictionary with all the coin coordinates
    """
    nearest_coin_cell=(1,1) # Default position maze exit
    distance = 100000
    for cell in coin_position_list:
...
def collectOnlyCoins(m, coin_position_list, start_cell = None, coin_target = COIN_TARGET):
    """
    Collect only the coins whilst placing wieght on paths with enemies
...
def objective_greedy(dimensions2x2):
    """ greedy player objective function """
...
def objective_neutral(dimensions2x2):
    """ neutral player objective function """
    cpNW = dimensions2x2[0]
    cpNE = dimensions2x2[1]
    cpSW = dimensions2x2[2]
    cpSE = 0.0
...
def objective_aggressive(dimensions2x2):
    """ aggressive player objective function """
    cpNW = dimensions2x2[0]
    cpNE = dimensions2x2[1]
    cpSW = dimensions2x2[2]
    cpSE = 0.0
...
def play_game(player, style='', n_iter = 1):
    ...
    for n in range(n_iter):
        ...
        #GP minimize method with optimal parameters
        ...
        # Forest Minimize method with optimal parameters
        # res = forest_minimize(
        #          player,                
        #          dimensions = dimensions2x2, 
        #          n_calls=510,
