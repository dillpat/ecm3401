...
def play_game(player, style='', n_iter = 1):
    ...
    for n in range(n_iter):
        ...
        np.random.seed(78912345)
        res = gp_minimize(player, dimensions = dimensions2x2, noise=0.001, acq_func='EI', initial_point_generator='lhs', random_state=54321987, n_points=20000, n_initial_points = 10, n_calls = 210)
